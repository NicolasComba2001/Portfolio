    ...
    return(
        <footer id='contacto'>
            ...
            <div className='footerInfo'>
                    <p className='footerInfo__texto'>¡Muchas gracias por visitarme! Aprecio que te hayas tomado el tiempo de ver cada detalle y muestra de información
                ...
                <div className='redes'>
                    ...
                    <figure className='redesCont'><a href="mailto:nicolaseliascomba2017@gmail.com?subject=Hola, queria felicitarte por tu portfolio...&body=¡Me ha encantado tu portfolio, te felicito! Quería comunicarme contigo para que podamos tener una charla, que te parece un café?"><img className='redesCont__red' src="RedesIMG/Gmail.svg" alt="nicolaseliascomba2017@gmail.com, en Gmail" /></a></figure>
                </div>
